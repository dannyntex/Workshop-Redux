...
2. Lo siguiente que vamos hacer al igual que hicimos anteriormente es crear las acciones. De momento vamos a crearmos un archivo action.js con dos acciones donde solo tenemos un propiedad Type.
